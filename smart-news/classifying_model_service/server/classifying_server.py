...
VARS_FILE = '../training/model/vars'
VOCAB_PROCESSOR_SAVE_FILE = '../training/model/vocab_procesor_save_file'
...
def loadModel():
    ...
    classifier = learn.Estimator(
        model_fn=news_cnn_model.get_cnn_model(N_CLASSES, n_words),
        model_dir=MODEL_DIR)
    # "Fake evaluate to setup params"
    df = pd.read_csv('../training/data/labeled_news.csv', header=None)
